#ifndef TYPEGRAPH_COLOR_MAP_H
#define TYPEGRAPH_COLOR_MAP_H
...
enum Color { WHITE = 0, GRAY = 1, GREEN = 2, BLACK = 3 };
...
class ColorMap {
  ...
  // long max_pos = -1;
public:
  template <class Graph> explicit ColorMap(Graph &graph) : colors(graph.capacity() / 4 + 64) {
